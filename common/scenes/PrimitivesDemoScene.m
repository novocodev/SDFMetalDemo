//
//  NewObjectModelScene.m
//  voĉo
//
//  Created by Andrew Reslan on 24/05/2016.
...
- (void) setupScene: (SDFScene *)scene {
    ...
    node0RedOctohedron.type = fEllipsoidType;
    node0RedOctohedron.materialId = 0;
    node0RedOctohedron.floats[9] = 0.25; // radius
    node0RedOctohedron.floats[10] = 0.15; // radius
    node0RedOctohedron.floats[11] = 0.35; // radius
    ...
    node2BlueOctohedron.type = fEllipsoidType;
    node2BlueOctohedron.materialId = 2;
    node2BlueOctohedron.floats[9] = 0.45; // radius
    node2BlueOctohedron.floats[10] = 0.85; // radius
    node2BlueOctohedron.floats[11] = 0.35; // radius
